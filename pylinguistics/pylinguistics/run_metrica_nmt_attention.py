...
# Experimento 04
path = '/home/alexandre/Desenvolvimento/mpes-experimentos/nmt-attention/ementas/'
path_stf = path + 'STF'
path_trf5 = path + 'TRF5'
...
metrica_ementa.generate_metrics_by_ementa("exp04_metricas_ementas_originais_TRF5.xlsx", "/*.br")
metrica_ementa.generate_metrics_by_ementa("exp04_metricas_ementas_simplificadas_TRF5.xlsx", "/*.sp")
